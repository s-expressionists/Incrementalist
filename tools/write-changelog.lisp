(cl:defpackage #:incrementalist.tools.write-changelog
  (:use
   #:cl)

  (:local-nicknames
   (#:ti #:incrementalist.tools.texinfo)
   (#:rc #:incrementalist.tools.read-changes))

  (:export
   #:emit-changelog))

(cl:in-package #:incrementalist.tools.write-changelog)
